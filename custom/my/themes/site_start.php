...
<noscript><img alt="" height="1" width="1" style="display:none"
    ...
    /></noscript>
<div class="hat_wrapper start_page ">
    ...
    <div class="advantages_section align">
        ...
        <div class="advantages_content">
            <div class="advantages_container">
                <div class="advantage_one">
                    <div class="advantage_one_img"><img src="https://bis-acc.ru/userfiles/bs/a1_1.png" loading="lazy"
                                                        alt="Команда" title=""></div>
                    <div class="advantage_one_title">Команда опытных специалистов</div>
                </div>
                <div class="advantage_one">
                    <div class="advantage_one_img"><img src="https://bis-acc.ru/userfiles/bs/a2_2.png" loading="lazy"
                                                        alt="Подход" title=""></div>
                    <div class="advantage_one_title">Индивидуальный подход к каждому клиенту</div>
                </div>
                <div class="advantage_one">
                    <div class="advantage_one_img"><img src="https://bis-acc.ru/userfiles/bs/a3_3.png" loading="lazy"
                                                        alt="Конфиденциальность" title=""></div>
                    <div class="advantage_one_title">Конфиденциальность коммерческой тайны</div>
                </div>
                <div class="advantage_one">
                    <div class="advantage_one_img"><img src="https://bis-acc.ru/userfiles/bs/a4_4.png" loading="lazy"
                                                        alt="Оперативность" title=""></div>
                    <div class="advantage_one_title">Оперативное решение поставленных задач</div>
                </div>
                <div class="advantage_one">
                    <div class="advantage_one_img"><img src="https://bis-acc.ru/userfiles/bs/a5_5.png" loading="lazy"
                                                        alt="Оптимизация" title=""></div>
                    <div class="advantage_one_title">Мы знаем как оптимизировать расходы на ведение бизнеса</div>
                </div>
                <div class="advantage_one">
                    <div class="advantage_one_img"><img src="https://bis-acc.ru/userfiles/bs/a6_6.png" loading="lazy"
                                                        alt="Успешность" title=""></div>
        ...
        <div class="text_wrapper">
            <div class="text_section align">
                <insert name="show_block" module="site" id="20"/>
            </div>
