$(document).ready(function () {
    $('.calc_option input[type="checkbox"], .input_wrapper select').styler();
    $('.calc_option input[type="radio"]').styler();
    a = new Array();
    a_text = new Array();
    a[6] = 1;
    a_text[6] = "";
...
$(document).on(
    "click",
    ".modal_window_container_close, .modal_window_wrapper",
    function (z) {
        z.preventDefault();
        z.stopPropagation();
...
$(document).on("click", ".pack_one_order_link", function (e) {
    e.preventDefault();
    pl = $(this).data("pak");
    $(".modal_window_wrapper").load("/zakaz/", function (response, status, xhr) {
        $(".phone_field").mask("+7-999-999-99-99");
        $("input[name=p19]").attr("value", pl);
        $(".modal_window_wrapper").fadeToggle(600);
    });
});

$(document).on("click", ".m_opener", function (e) {
    e.preventDefault();
    $(this).next().slideToggle();
    $(this).toggleClass("opened");
});
$(document).ready(function () {
    //$('.opened').next().addClass('opened');
    //$('.opened').next().addClass('opened');
    $('li a:contains("Аутсорсинг")').siblings(".type_menu_2").show();
    $('li a:contains("Аутсорсинг")').siblings(".m_opener").toggleClass("opened");
    $(".for_services_topmenu").hover(function () {
        $(this).toggleClass("opened");
        $(".with_second_menutop").toggle();
        $(".with_second_menutop").hover(function () {
            $(".with_second_menutop").show();
        });
    });
});

/*
$(".type_menu li:not(:contains('Аутсорсинг'))").hover(
	function(){
		$("ul", this).delay(2000).slideDown();
		$(this).children( ".type_menu_2" ).not( ".opened" ).toggleClass('opened');
		$(this).children('.m_opener').not( ".opened" ).toggleClass('opened');
	},
	function(){
		$(this).children( ".type_menu_2" ).stop(true, true).slideUp();
	}
)

$(".type_menu li:contains('Аутсорсинг')").children('.type_menu_2').children('li').hover(
	function(){
		//$(this).children( ".type_menu_3" ).not( ".opened" ).delay(1000).slideDown('slow');
		$("ul", this).delay(2000).slideDown('slow');
		$(this).children( ".type_menu_2" ).not( ".opened" ).toggleClass('opened');
		$(this).children('.m_opener').not( ".opened" ).toggleClass('opened');
	},
	function(){
...
// $(".type_menu li:not(:contains('Аутсорсинг'))").hover(
// 	function(){
// 		$("ul", this).delay(700).slideDown('slow');
// 		$(this).children('.m_opener').addClass('opened');
// 		//$("ul", this).delay(1000).addClass('opened');
// 		//$(this).children( ".type_menu_2" ).not( ".opened" ).addClass('opened');
// 	},
// 	function(){
// 		$("ul", this).stop(true, true).slideUp('slow');
// 		$(this).children('.m_opener').removeClass('opened');
// 	}
// )

$(document).ready(function () {
    $(".type_menu li:contains('Аутсорсинг')")
        .children(".type_menu_2")
        .children("li")
        .each(function () {
            //$(this).hover(function(){
            $(".active").next().addClass("opened");
            $(".active").siblings("ul").show("slow");
            $(".active").siblings("ul").addClass("opened");
        });
    $(".type_menu li:not(:contains('Аутсорсинг'))").each(function () {
        //$(this).hover(function(){
        $(".active").next().addClass("opened");
        $(".active").siblings("ul").show("slow");
        $(".active").siblings("ul").addClass("opened");
    });
    $(".calc_field_wrap select").styler();
});
...
/*
	...
	$(".type_menu li:not(:contains('Аутсорсинг'))").each(function(){
		//$(this).hover(function(){
			...
			var timeoutId;
					$(".type_menu li:not(:contains('Аутсорсинг'))").hover(function(){
						if (!timeoutId) {
			            	timeoutId = window.setTimeout(function() {
				                timeoutId = null;
								$(this).children( ".type_menu_2" ).not( ".opened" ).slideToggle('slow');
								$(this).children( ".type_menu_2" ).not( ".opened" ).toggleClass('opened');
								$(this).children('.m_opener').not( ".opened" ).toggleClass('opened');
									if ($('.type_menu_2').hasClass('opened')) {
					...
					function(){
						 if (timeoutId) {
				            ...
				            timeoutId = null;
				           // $(this).children( ".type_menu_2" ).slideToggle('slow');
							//$(this).children( ".type_menu_2" ).toggleClass('opened');
							//$(this).children( "m_opener" ).toggleClass('opened');
				        }
				        else {
							$(this).children( ".type_menu_2" ).slideToggle('slow');
							$(this).children( ".type_menu_2" ).toggleClass('opened');
	...
	$(".type_menu li:contains('Аутсорсинг')").children('.type_menu_2').children('li').each(function(){
		//$(this).hover(function(){
			$('.active').next().addClass('opened');
			$('.active').siblings('ul').show('slow');
			$('.active').siblings('ul').addClass('opened');
			...
			$(this).hover(function(){
				if (!timeoutt) {
			        timeoutt = window.setTimeout(function() {
				        timeoutt = null;
							$(this).children('.type_menu_3').not( ".opened" ).slideToggle('slow');
							$(this).children('.type_menu_2').not( ".opened" ).toggleClass('opened');
							$(this).children('.m_opener').not( ".opened" ).toggleClass('opened');
					}, 500);
			    }
			...
			function(){
						 if (timeoutt) {
				           ...
				           // $(this).children( ".type_menu_2" ).slideToggle('slow');
							...
							$(this).children( ".type_menu_3" ).slideToggle('slow');
							$(this).children( ".type_menu_2" ).toggleClass('opened');
							$(this).children( "m_opener" ).toggleClass('opened');
						};
					});
...
*/
$(document).on("change", "#calc1 .calc_option input", function (e) {
    $("#calc_dalee[data-step=" + $(this).data("quest") + "]").addClass("active");
    if ($(this).prop("checked")) {
        if ($(this).attr("type") == "radio") {
            a[$(this).data("quest")] = $(this).data("answ");
            a_text[$(this).data("quest")] = $(this)
                .parents(".calc_option")
                .find("label")
                .text();
        } else {
            a[$(this).data("quest")] =
                a[$(this).data("quest")] * $(this).data("answ");
            a_text[$(this).data("quest")] =
                a_text[$(this).data("quest")] +
                "|" +
                $(this).parents(".calc_option").find("label").text();
        }
    }
});

$(document).on("change", "#calc2 .calc_option input", function (e) {
    $("#calc_dalee1[data-step=" + $(this).data("quest") + "]").addClass("active");
    if ($(this).prop("checked")) {
        if ($(this).attr("type") == "radio") {
            b[$(this).data("quest")] = $(this).data("answ");
            b_text[$(this).data("quest")] = $(this)
                .parents(".calc_option")
                .find("label")
                .text();
        } else {
...
// $('.calc_field_wrap select, [name="calk_type"]').on("change", function () {
// 	//fbq('track', 'InitiateCheckout');
// 	$(".calc_field_wrap select").removeClass("error_input");

// 	var parent = $(this).parents("#calc1");
// 	parent.find('[name="p20"]').first().removeClass("error_input");
// 	parent.find('[name="p21"]').first().removeClass("error_input");

// 	const calk_type = parent.find('[name="calk_type"]:checked').first().val();
// 	const cost_base = parent
// 		.find('select[name="b_cost"]')
// 		.first()
// 		.children("option:selected")
// 		.attr("data-answ");
// 	const k1 = parent
// 		.find('select[name="k_1"]')
// 		.first()
// 		.children("option:selected")
// 		.attr("data-answ");
// 	const k2 = parent
// 		.find('select[name="k_2"]')
// 		.first()
// 		.children("option:selected")
// 		.attr("data-answ");
// 	const k3 = parent
// 		.find('select[name="k_3"]')
// 		.first()
// 		.children("option:selected")
// 		.attr("data-answ");
// 	let res = Math.round(
// 		Number(cost_base) * Number(k1) * Number(k2) * Number(k3),
// 	);

// 	if (calk_type == 0) {
// 		res = res - res * 0.2;
// 		res = Math.max(res, cost_base);
// 	}

// 	parent.find("#calc_res").first().text(Math.round(res));

// 	let res_text =
// 		"Система налогообложения: " +
// 		$('select[name="b_cost"]').val() +
// 		"; Вид деятельности: " +
// 		$('select[name="k_1"]').val() +
// 		"; Кол-во персонала: " +
// 		$('select[name="k_2"]').val() +
...
// 		$('[name="calk_type"]:checked').attr("data-title") +
// 		"; Стоимость: " +
// 		Math.round(res) +
// 		" руб.";
// 	$("input[name=p23]").attr("value", res_text);

// 	if (isNaN(res)) {
// 		// parent.find('.form_misc').first().slideUp();
// 	} else {
// 		// parent.find('.form_misc').first().slideDown();
// 		console.log(sotr_count);
// 		if (calk_type == 0) {
// 			let test = Math.round(
// 				Number(cost_base) * Number(k1) * Number(k2) * Number(k3),
// 			);
// 			console.log(
// 				`(cost_base: ${cost_base} * k1: ${k1} * k2: ${k2} * k2:${k3}) - 20 % = ${test} - 20% = ${res} (cost_base ${
// 					res > cost_base ? "<" : ">"
// 				} res)`,
// 			);
// 		} else {
// 			console.log(
// 				`cost_base: ${cost_base} + k1: ${k1} + k2: ${k2} + k2:${k3} = ${res}`,
// 			);
// 		}
// 	}
// });
...
$("#calculator_new .feedback_form").submit("submit", function (e) {
    e.preventDefault();
    var parent = $(this).parents("#calc1");
    let arr = [
        parent.find('select[name="b_cost"]').first(),
        parent.find('select[name="k_1"]').first(),
        parent.find('select[name="k_2"]').first(),
        parent.find('select[name="k_3"]').first(),
        parent.find('[name="p20"]').first(),
        parent.find('[name="p21"]').first(),
    ];
    arr = arr.filter((el) => el.val() === "");
    console.log("sended", arr);
    if (arr.length) {
        arr.map((el) => el.addClass("error_input"));
        return false;
    }
});

$(document).on("click", "#calc_dalee", function (e) {
    e.preventDefault();
    //fbq('track', 'InitiateCheckout');
    if ($(this).hasClass("active")) {
        step = $("#calc_dalee").data("step") + 1;
        if (step - 1 == 1)
            gtag("event", "More", {
        ...
        $("#calc1 .calc_step_wrap, #calc1 .calc_step").removeClass("active");
        $("#calc_dalee").data("step", step);
        $("#calc_dalee").attr("data-step", step);
        $("#calc1 .calc_step_wrap[data-step=" + step + "]").addClass("active");
        $("#calc1 .calc_step[data-step=" + step + "]").addClass("active");
        $("#calc_dalee").removeClass("active");
        if (step == 7) {
            $(this).hide();
            res = 0;
            if (a[3] == "N" || a[4] == "N" || a[5] == "N") {
                $("#calc1 .calc_subcontainer_last p:first-child").text(
                    "Указанные Вами условия требуют индивидуального расчета.",
                );
            } else {
                res = a[1] * a[4] * a[2] * a[3] * a[5] * a[6];
                $("#calc1 #calc_res").text(Math.round(res));
            }
            res_text =
                "Система налогообложения: " +
                a_text[1] +
...
$(document).on("click", "#calc_dalee1", function (e) {
    e.preventDefault();
    if ($(this).hasClass("active")) {
        step = $("#calc_dalee1").data("step") + 1;
        $("#calc2 .calc_step_wrap, #calc2 .calc_step").removeClass("active");
        $("#calc_dalee1").data("step", step);
        $("#calc_dalee1").attr("data-step", step);
        $("#calc2 .calc_step_wrap[data-step=" + step + "]").addClass("active");
        $("#calc2 .calc_step[data-step=" + step + "]").addClass("active");
        $("#calc_dalee1").removeClass("active");
        if (step == 8) {
            $(this).hide();
            res = 0;
            if (b[1] == "N") {
                $("#calc2 .calc_subcontainer_last p:first-child").text(
                    "Указанные Вами условия требуют индивидуального расчета.",
                );
            } else {
                res = sotr_count * b[1] * b[2] * b[3] * b[4] * b[5] * b[6] * b[7];
                console.log(res);
                $("#calc2 #calc_res").text(Math.round(res));
            }
            res_text =
                "Кол-во сотрудников: " +
                sotr_count +
                ...
                Math.round(res) +
                " руб.";
            $("input[name=p27]").attr("value", res_text);
        }
    }
});

$(document).on("click", ".calc_step", function (e) {
    e.preventDefault();
});

$(document).on("click", "#refresh_calc", function (e) {
    e.preventDefault();
    a[6] = 1;
    a_text[6] = "";
    $("#calc1 .calc_step_wrap, #calc1 .calc_step").removeClass("active");
    $("#calc1 .calc_option input").prop("checked", false);
    $("#calc1 .calc_option input").trigger("refresh");
    step = 1;
    $("#calc_dalee").data("step", step);
    $("#calc_dalee").attr("data-step", step);
    $("#calc1 .calc_step_wrap[data-step=" + step + "]").addClass("active");
    $("#calc1 .calc_step[data-step=" + step + "]").addClass("active");
    $("#calc_dalee").removeClass("active").show();
});

$(document).on("input", "#o_0", function (e) {
    if ($(this).val() > 0) {
        sotr_count = $(this).val();
        if (sotr_count <= 200) b[1] = $("#o_1").data("answ");
        if (sotr_count > 200 && sotr_count <= 400) b[1] = $("#o_2").data("answ");
        if (sotr_count > 400) b[1] = $("#o_3").data("answ");
        $("#calc_dalee1[data-step=" + $(this).data("quest") + "]").addClass(
            "active",
        );
    } else {
        alert("Количество сотрудников должно быть больше 0");
    }
    console.log(sotr_count);
});
...
if ($(".text_tabs").length > 0) {
    var tt1 = 1;
    var tt2 = 1;
    $(".text_tabs__tab").each(function () {
        $(this).attr("data-tab", "TTab" + tt1);
        tt1++;
    });
    $(".text_tabs__content").each(function () {
        $(this).addClass("TTab" + tt2);
        tt2++;
    });
    if ($(".text_tabs__tab.active").length == 0) {
        $(".text_tabs__tab:first-child").addClass("active");
    } else {
        if ($(".text_tabs__tab.active").length > 1) {
            $(".text_tabs__tab.active").removeClass("active");
            $(".text_tabs__tab:first-child").addClass("active");
        }
    }
    $(".text_tabs__tab").css("width", 100 / $(".text_tabs__tab").length + "%");
    $("." + $(".text_tabs__tab.active").attr("data-tab")).css("display", "block");
    $(".text_tabs__tab").on("click", function () {
        $(".text_tabs__tab").removeClass("active");
        $(this).addClass("active");
        $(".text_tabs__content").hide();
...
if (calc) {
    ...
    // imask.js
    const phoneCtrls = document.querySelectorAll(".lw-phone-mask");
    if (phoneCtrls.length) {
        phoneCtrls.forEach((ctrl) => {
            IMask(ctrl, {
    ...
    const sels = document.querySelectorAll(".custom-select");
    ...
    if (sels) {
        ...
        const setValues = () => {
            const type = document
                .querySelector('[data-type="company-type"]')
                .querySelector("option:checked")
                .getAttribute("data-value");
            const tax = document
                .querySelector('[data-type="tax-system"]')
                .querySelector("option:checked")
                .getAttribute("data-value");
        ...
        const fillTotalPriceNode = (price) => {
            const accountingType = document.querySelector(
                '[data-type="accounting-type"]:checked',
            ).value;
            const type = document
                .querySelector('[data-type="company-type"]')
                .querySelector("option:checked").innerHTML;
            const tax = document
                .querySelector('[data-type="tax-system"]')
                .querySelector("option:checked").innerHTML;
            const operationCount = document
                .querySelector('[data-type="operation-count"]')
                .querySelector("option:checked").innerHTML;

            const text = `Я cамостоятельно веду учет товара в 1С УТ: ${accountingType}; Форма собственности: ${type}; Система налогообложения: ${tax}; Количество сотрудников: ${staffCount.value}; Количество хозяйственных операций: ${operationCount}; Предварительная стоимость: ${price} руб./мес.`;

            const resTitle = document.createElement("span");
            resTitle.classList.add("lw-calc__res-title");
            resTitle.innerHTML =
                "Предварительная стоимость бухгалтерского обслуживания составит";

            const resValue = document.createElement("span");
            resValue.classList.add("lw-calc__res-value");
            resValue.innerHTML = `${Math.round(price)} руб./мес.`;

            const resWrap = document.createElement("div");
            resWrap.setAttribute("id", "calc_res");

            const resText = document.createElement("span");
            resText.classList.add("lw-calc__res-text");
            resText.innerHTML =
                "Для уточнения стоимости мы свяжемся с вами в течение дня!";

            const resNode = document.querySelector(".lw-calc .novisres");
            resNode.innerHTML = "";
            resWrap.appendChild(resTitle);
            resWrap.appendChild(resValue);
            resWrap.appendChild(resText);
            resNode.appendChild(resWrap);

            document.querySelector('.lw-calc input[name="p23"]').value = text;
        };
        ...
        const setTotalPrice = () => {
            const count = document
                ...
                .querySelector("option:checked")
                .getAttribute("data-value");
            total = base + step * (count - 1);
            const accounting = document
                .querySelector('[data-type="accounting-type"]:checked')
                .getAttribute("data-value");
            ...
            total += staffCount.value * 500;
            fillTotalPriceNode(total);
        };

        sels.forEach((sel) => {
            sel.addEventListener("change", () => {
                if (sel.getAttribute("data-type") === "operation-count") {
                    setTotalPrice();
                } else {
                    setValues();
                }
        ...
        const accountingTypes = document.querySelectorAll(
            '[data-type="accounting-type"]',
        );
        ...
        // counter
        const counter = document.querySelector(".lw-counter");
        const decBtn = counter.querySelector(".lw-counter-btn--dec");
        const incBtn = counter.querySelector(".lw-counter-btn--inc");
        ...
        decBtn.addEventListener("click", () => {
            ...
            if (
                ...
                !decBtn.classList.contains("lw-counter-btn--disabled")
            ) {
                decBtn.classList.add("lw-counter-btn--disabled");
            }
        });
        ...
        incBtn.addEventListener("click", () => {
            ...
            setTotalPrice();
            if (
                Number(input.value) === Number(1) &&
                decBtn.classList.contains("lw-counter-btn--disabled")
            ) {
                decBtn.classList.remove("lw-counter-btn--disabled");
            }
        });

        const staffCount = input;
        staffCount.addEventListener("change", () => {
            setTotalPrice();
        });
        // counter
...
$(document).ready(function () {
    ...
    $('.parent .url-wrapper svg').click(function () {
        if (this.classList.contains('arrow-bottom')) {
            $(this).closest('.parent').find('.dropdown-top-menu').show();
            this.classList.replace('arrow-bottom','arrow-top')
            $(this).closest('.parent').find('.url-wrapper').addClass('active')
        } else {
            $(this).closest('.parent').find('.dropdown-top-menu').hide();
            this.classList.replace('arrow-top','arrow-bottom')
            $(this).closest('.parent').find('.url-wrapper').removeClass('active')
        }
    })

    $('.url-wrapper_level2 svg').click(function () {
        if (this.classList.contains('arrow-bottom')) {
            $(this).closest('li').find('.top_menu_3').show();
            this.classList.replace('arrow-bottom','arrow-top')
        } else {
            $(this).closest('li').find('.top_menu_3').hide();
            this.classList.replace('arrow-top','arrow-bottom')
        }
    })
